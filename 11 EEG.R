...
alpha1 <- read_excel("Data/EEG_excuding_trials_with_wrong_responses/Auswertung/app-files/bins1/TFO_alphas_Pz7_2.xls")
alpha1_long <- alpha1 %>%
...
alpha2 <- read_excel("Data/EEG_excuding_trials_with_wrong_responses/Auswertung/app-files/bins1/TFO_alphas_Pz7_6.xls")
alpha2_long <- alpha2 %>%
  pivot_longer(High_Passive:Low_Active, 
               names_to = "ActPass", values_to = "value")%>%
  mutate(Intensity = ifelse(str_detect(ActPass,"High"),"High","Low"))%>%
...
alpha3 <- read_excel("Data/EEG_excuding_trials_with_wrong_responses/Auswertung/app-files/bins1/TFO_alphas_Pz7_20.xls")
alpha3_long <- alpha3 %>%
  pivot_longer(High_Passive:Low_Active, 
               names_to = "ActPass", values_to = "value")%>%
  mutate(Intensity = ifelse(str_detect(ActPass,"High"),"High","Low"))%>%
...
alpha.df <- data.frame()
for (bin in 1:20) {
  alpha <- read_excel(paste0("Data/EEG_excuding_trials_with_wrong_responses/Auswertung/app-files/bins1/TFO_alphas_Pz7_",bin,".xls"))
...
#ANOVA 500-1000 ms after cue onset
alpha1_high <- read_excel("Data/EEG_excuding_trials_with_wrong_responses/Auswertung/app-files/bins1/TFO_high_alphas_Pz7_2.xls")
...
#ANOVA 2500-3000 ms after cue onset
alpha2_high <- read_excel("Data/EEG_excuding_trials_with_wrong_responses/Auswertung/app-files/bins1/TFO_high_alphas_Pz7_6.xls")
...
#ANOVA 9500-10000 ms after cue onset
alpha3_high <- read_excel("Data/EEG_excuding_trials_with_wrong_responses/Auswertung/app-files/bins1/TFO_high_alphas_Pz7_20.xls")
...
for (bin in 1:20) {
  alpha <- read_excel(paste0("Data/EEG_excuding_trials_with_wrong_responses/Auswertung/app-files/bins1/TFO_high_alphas_Pz7_",bin,".xls"))
  alpha <- alpha %>% mutate(time = as.numeric(bin))
...
#ANOVA 500-1000 ms after cue onset
alpha1_low <- read_excel("Data/EEG_excuding_trials_with_wrong_responses/Auswertung/app-files/bins1/TFO_low_alphas_Pz7_2.xls")
...
#ANOVA 2500-3000 ms after cue onset
alpha2_low <- read_excel("Data/EEG_excuding_trials_with_wrong_responses/Auswertung/app-files/bins1/TFO_low_alphas_Pz7_6.xls")
...
#ANOVA 9500-10000 ms after cue onset
alpha3_low <- read_excel("Data/EEG_excuding_trials_with_wrong_responses/Auswertung/app-files/bins1/TFO_low_alphas_Pz7_20.xls")
...
for (bin in 1:20) {
  alpha <- read_excel(paste0("Data/EEG_excuding_trials_with_wrong_responses/Auswertung/app-files/bins1/TFO_low_alphas_Pz7_",bin,".xls"))
  alpha <- alpha %>% mutate(time = as.numeric(bin))
